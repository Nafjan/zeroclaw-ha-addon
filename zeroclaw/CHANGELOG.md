...
- Recover the exact legacy fenced guarded-action form even when Telegram or a
  provider adds surrounding blank lines or CRLF transport whitespace; the
  recovered action still passes through the typed broker and policy gate.
